...
def validate_silver_tables(**context):
    ...
    for table_name, key_cols in tables_to_check.items():
        # f1_lakehouse tiene schemas habilitados, las tablas quedan en Tables/dbo/ y no en Tables/
        ...
        # chequeo de duplicados en fact_laps
...
def validate_gold_tables(**context):
    ...
    # dbt escribe los modelos Gold en el schema dbo_gold (viene de dbo + +schema: gold)
    ...
    try:
        ...
        # checkeo que la tabla de features este sana: sin nulos en key/label y las 3 clases presentes
        cur.execute(
