...
For the historical backfill (2019-2024) trigger manually from the Airflow UI.
...
# cantidad de carreras por temporada, lo uso para generar las tasks del backfill
SEASON_ROUNDS = {
    2019: 21,
    2020: 17,
    2021: 22,
...
with DAG(
    ...
    description="Ingest F1 data (fastf1 + Ergast) to Bronze - historical 2019-2024",
    ...
    for year, total_rounds in SEASON_ROUNDS.items():
        # una task de dimensiones por temporada
        ...
        # una task por cada GP de la temporada
