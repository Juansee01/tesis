...
select
    ...
    -- consistencia: cuanto mas bajo mejor (desvio estandar de los tiempos, sin outliers)
...
left join races rc
    on rc.year = l.year and rc.round = l.round
group by
    l.year, l.round, rc.race_name, rc.country, l.driver_id, d.forename, d.surname,
